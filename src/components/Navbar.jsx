...
const Navbar = ({theme, setTheme}) => {
  ...
  return (
    ...
    <div>
        <a href="#contact-us" className="text-sm max-sm:hidden flex items-center gap-2 bg-primary text-white px-6 rounded-full cursor-pointer hover:scale-103 transition-all">
            Connect <img src={assets.arrow_icon} className='inline-block ml-2 w-14' alt="arrow" />
        </a>
    </div>
    </div>
  )
